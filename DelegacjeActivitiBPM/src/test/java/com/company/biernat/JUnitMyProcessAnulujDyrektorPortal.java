...
public class JUnitMyProcessAnulujDyrektorPortal {
  ...
  public void startProcess() throws Exception {
    ...
    // Będzie webservice jako portal zakupowy, do ktorego listener podłączony do
    // kolejki bedzie wysylal zapytania
    task = taskService.createTaskQuery().executionId(processInstance.getId())
        .singleResult();
    assertNull(task.getAssignee());
    ...
    // Uzytkownik akceptuje propozycje portalu zakupowego(hotel itp),jezeli nie
    // wysyla ponownie zapytanie w celu dostania innej propozycji
    task = taskService.createTaskQuery().executionId(processInstance.getId())
        .singleResult();
